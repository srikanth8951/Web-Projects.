...
<body>
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our Institute is located in Ujire, a well known place of learning. Our college is affiliated to Visvesvaraya Technological University, Belgaum (Karnataka). Within a short span of 10 years we have made our presence felt strongly in this competitive educational sector and we have many firsts to our credit.Our credentials are well appreciated by many industries, engineering institutes, professional bodies, government organizations etc.
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of SDMIT</h3>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">SDM Institute of Technology</h6>
					<h4>
						<a href="../Homepage/index.php" style="color: white">Campus Recruitment System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
