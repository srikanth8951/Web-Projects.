        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to CRS</h2>
              <p></p>
              <p>Hello Officer! Have a great day with us! With CRS Account, You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
              <p>Hope you enjoy doing that. Greetings!!</p>
              <p><a href="PlacementDrives.php">Campus Drives</a></p>
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <img src="images/banner.jpg" alt="Bicycle" class="img-circle img-thumbnail">
            </div>
            ...
            <div class="col-1">              
              <div class="templatemo-content-widget orange-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-circle" src="images/UI.png" alt="Sunset">
                    </a>
                  </div>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-circle" src="images/PN.png" alt="Sunset">
                    </a>
                  </div>
                  <div class="media-body">
