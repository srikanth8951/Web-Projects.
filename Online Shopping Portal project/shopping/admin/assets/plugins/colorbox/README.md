...
* Updated the example index.php files to be HTML5 compliant.
...
* Changed the index.php example files to use YouTube's new embedded link format.
...
Files Changed: jquery.colorbox.js/jquery.colorbox-min.js/index.php
